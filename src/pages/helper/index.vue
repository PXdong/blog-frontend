<!--
 * @Author: dongpx
 * @Date: 2021-03-23 15:28:49
 * @LastEditTime: 2021-03-23 15:28:50
 * @LastEditors: dongpx
 * @Description: 
 * @FilePath: /laziji/src/pages/helper/index.vue
-->
<template>
  <div>
      ...
      <el-collapse v-model="active" accordion>
        <el-collapse-item title="如何部署" name="deploy">
          ...
          >
            ...
            >
              <div
                style="border-radius:5px; border: 1px solid #EBEEF5;height: 350px;"
              >
        ...
        <el-collapse-item title="开发注意事项" name="develop">
          <div
            style="padding: 10px;line-height: 30px;color: #303133;font-size: 16px"
          >
            配置文件读取的总是与
